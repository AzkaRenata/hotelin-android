...
public class RoomTemp {
    ...
    public RoomTemp(int id, String hotel_name, String room_type, String bed_type, String room_price, String guest_capacity, String room_picture, String facility_name, String facility_icon, int booking_status, String check_in, String check_out, String user_id, boolean is_booked) {
        this.id = id;
    ...
    public RoomTemp(int id, String hotel_name, String room_type, String bed_type,
