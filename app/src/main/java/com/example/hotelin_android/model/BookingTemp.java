...
public class BookingTemp {
    ...
    public BookingTemp(String hotel_name, String room_type, String room_price, String namaPemesan, String email, String telp, int room_id, String check_in, String check_out) {
